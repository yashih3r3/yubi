...
#os.system("espeak -a 300 \"welcome,to,yashi,babe,tool,\"")
#time.sleep(2)
from os import path
...
#------------------[ YASHI-BABE ]-------------------#
import os, platform, time, sys
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m wait machikney...? ')
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m ADD on Facebook")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=61550853227995&mibextid=kFxxJD/')
#-----------------------[ IMPORT-CODE ]-----------------------#
import os
import sys
...
if not len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/models.py','r').readlines())==1034:print('Welcome User')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/yashih3r3/File-Cloning/blob/main/Approved.txt').text
    open('.prox.txt','w').write(prox)
except Exception as e:
    pass
    prox=open('.prox.txt','r').read().splitlines()
...
def back():
    menu()
def contact():
    os.system('xdg-open https://m.me/j/AbbmBdmQW-SCAOeT/')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;37;1m-----------------------------------------------
 AUTHOR     : Y4SHI KAKA
 GITHUB     : yashih3r3
 FACEBOOK   : YASHI BRAND ✅
 TOOLS     \033[1;97m : \x1b[97m\033[37;41m TRIAL\033[0;m
...
def setting():
    print('\033[0;97m-----------------------------------------------')
    print(" [\u001b[36m1\033[1;37m] ONLY OLD IDZ    (slow)")
    print(" [\u001b[36m2\033[1;37m] ONLY NEW IDZ   (Best)")
    ...
    print('\033[0;97m-----------------------------------------------')
    print(" [\u001b[36m1\033[1;37m] CLICK 1 TO START")
